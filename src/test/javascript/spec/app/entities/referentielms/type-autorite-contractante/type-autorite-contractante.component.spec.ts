...
import { TypeAutoriteContractanteComponent } from 'app/entities/referentielms/type-autorite-contractante/type-autorite-contractante.component';
  ...
  describe('TypeAutoriteContractante Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new TypeAutoriteContractante(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.typeAutoriteContractantes && comp.typeAutoriteContractantes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
