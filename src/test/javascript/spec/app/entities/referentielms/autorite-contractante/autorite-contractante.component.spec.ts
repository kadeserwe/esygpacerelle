...
import { AutoriteContractanteComponent } from 'app/entities/referentielms/autorite-contractante/autorite-contractante.component';
...
describe('Component Tests', () => {
  describe('AutoriteContractante Management Component', () => {
    ...
    beforeEach(() => {
      ...
      service = fixture.debugElement.injector.get(AutoriteContractanteService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new AutoriteContractante(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.autoriteContractantes && comp.autoriteContractantes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
