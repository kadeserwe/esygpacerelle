...
import { DelaisComponent } from 'app/entities/referentielms/delais/delais.component';
...
describe('Component Tests', () => {
  describe('Delais Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.delais && comp.delais[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
