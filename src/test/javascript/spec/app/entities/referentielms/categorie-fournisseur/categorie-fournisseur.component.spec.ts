...
import { CategorieFournisseurComponent } from 'app/entities/referentielms/categorie-fournisseur/categorie-fournisseur.component';
  ...
  describe('CategorieFournisseur Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CategorieFournisseur(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.categorieFournisseurs && comp.categorieFournisseurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
