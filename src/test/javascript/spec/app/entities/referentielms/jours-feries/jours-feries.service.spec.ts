...
describe('Service Tests', () => {
  describe('JoursFeries Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(JoursFeriesService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new JoursFeries(0, currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a JoursFeries', () => {
        ...
        service.create(new JoursFeries()).subscribe(resp => (expectedResult = resp.body));
