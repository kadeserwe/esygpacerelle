...
describe('Service Tests', () => {
  describe('SpecialitesPersonnel Service', () => {
    ...
    let elemDefault: ISpecialitesPersonnel;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(SpecialitesPersonnelService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new SpecialitesPersonnel(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a SpecialitesPersonnel', () => {
        ...
        service.create(new SpecialitesPersonnel()).subscribe(resp => (expectedResult = resp.body));
