...
import { ModeSelectionComponent } from 'app/entities/referentielms/mode-selection/mode-selection.component';
...
describe('Component Tests', () => {
  describe('ModeSelection Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.modeSelections && comp.modeSelections[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
