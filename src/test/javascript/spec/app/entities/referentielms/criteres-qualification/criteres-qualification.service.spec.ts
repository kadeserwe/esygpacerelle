...
describe('Service Tests', () => {
  describe('CriteresQualification Service', () => {
    ...
    let elemDefault: ICriteresQualification;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(CriteresQualificationService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new CriteresQualification(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a CriteresQualification', () => {
        ...
        service.create(new CriteresQualification()).subscribe(resp => (expectedResult = resp.body));
